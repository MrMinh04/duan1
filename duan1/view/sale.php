<style>
    .sale {
        ...
        <section class="banner" style="position: relative;">
            <img id="slider"src="../images/banner_sale.jpg" alt="">
        ...
        <section class="content">
            <?php foreach ($sale_product as $key => $value): ?>
        ...
        <section class="content2">
            <?php foreach ($sale_featured as $key => $value): ?>
            <a href="index.php?act=sanphamct&product_id=<?=$value['product_id']?>">
            <section class="sp">
                <img style="height: 270px; width: 270px;" src="../images/<?=$value['product_image']?>" alt="">
                <section class="thongTin">
...
<script>
    var images = ["../images/banner_sale.jpg","../images/banner_sale3.jpg","../images/banner_sale5.jpg"];
    var num = 0;
    function next(){
