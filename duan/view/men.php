...
$sql_men_product = "SELECT * FROM product ";
$men_product = pdo_query($sql_men_product);
$sql_men_featured = "SELECT * FROM product WHERE product_category=3";
...
<body>
    <div class="container">
        ...
        <section class="thanhDieuHuong">
            ...
            <nav class="menu2">
                <a href="men.php" style="text-decoration: underline 2px black;">Men</a>
